...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String APP_PREFERENCES_SPAN = "10";//Machine SPAN
    public static final String APP_PREFERENCES_FACEDIA = "20";//Face diameter
    public static final String APP_PREFERENCES_OH = "30";//Overhang
    public static final String APP_PREFERENCES_BBT = "40";//Bore bottom target
    public static final String APP_PREFERENCES_FBT = "50";//Face bottom target
    public static final String APP_PREFERENCES_BBR = "60";//Bore bottom reading
    public static final String APP_PREFERENCES_FBR = "70";//Face bottom reading
    public static final String APP_PREFERENCES_SPACING = "80";//Machine spacing
    public static final String APP_PREFERENCES_3BT = "90";//3 o'clock bore target
    public static final String APP_PREFERENCES_3FT = "100";//3 o'clock face target
    public static final String APP_PREFERENCES_3BR = "110";//3 o'clock bore reading
    public static final String APP_PREFERENCES_3FR = "120";//3 o'clock face reading
    public static final String APP_PREFERENCES_9BT = "130";//9 o'clock bore target
    public static final String APP_PREFERENCES_9BR = "140";//9 o'clock bore reading
    public static final String APP_PREFERENCES_FFA = "150";//Face only far foot adjustment
    public static final String APP_PREFERENCES_FNA = "160";//Face only near foot adj
    public static final String APP_PREFERENCES_TFA = "170";//Total far foot adj
    public static final String APP_PREFERENCES_TNA = "180";//Total near foot adj
    public static final String APP_PREFERENCES_BA = "190";//Bore only adj
    public static final String APP_PREFERENCES_RATIO="200";//ratio of SPAN to machine spacing (or m.s.+OH)
    public static final String APP_PREFERENCES_delta1 = "210";//see excel
    public static final String APP_PREFERENCES_config = "2";//so, si, mo or mi
/*
